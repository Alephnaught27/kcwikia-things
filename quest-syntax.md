...
`Craft (a (piece) / X (pieces)) (of) (ship(s)/ equipment).` [ For crafting quests ]

`[Scrap/Dismantle] (a (piece) / X (pieces)) (of) (ship(s)/ equipment).` [ For scrap quests ]
...
(Å¶ (Equipped) & (prepared) equipment must be unlocked.)
(Å¶ The equipped X will be converted to the reward listed.)
(Å¶ The prepared (resources), (items), and (equipment) will be consumed upon quest completion.)
